    ...
    <g style="fill: #fff; fill-opacity: 1">
      <g
        style="
          fill: currentColor;
          fill-opacity: 1;
          stroke-width: 0.09651081;
          stroke-miterlimit: 4;
          stroke-dasharray: none;
        "
      >
        <path
          d="M6.542 294.178c1.078 0 1.125.858 1.125 1.495H2.069c0-.65.046-1.495 1.124-1.495z"
          style="
            fill: currentColor;
            fill-opacity: 1;
            stroke: #8c8c8c;
            stroke-width: 0.38604325;
            stroke-linecap: butt;
